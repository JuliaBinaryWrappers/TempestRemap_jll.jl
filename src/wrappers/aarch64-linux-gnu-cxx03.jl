# Autogenerated wrapper script for TempestRemap_jll for aarch64-linux-gnu-cxx03
export AnalyzeMap_exe, ApplyOfflineMap_exe, CalculateDiffNorms_exe, CoarsenRectilinearData_exe, ConvertExodusToSCRIP_exe, ConvertSCRIPToExodus_exe, GenerateCSMesh_exe, GenerateGLLMetaData_exe, GenerateICOMesh_exe, GenerateLambertConfConicMesh_exe, GenerateOfflineMap_exe, GenerateOverlapMesh_exe, GenerateOverlapMesh_v1_exe, GenerateRLLMesh_exe, GenerateRectilinearMeshFromFile_exe, GenerateStereographicMesh_exe, GenerateTestData_exe, GenerateTransectMesh_exe, GenerateTransposeMap_exe, GenerateUTMMesh_exe, GenerateVolumetricMesh_exe, MeshToTxt_exe, RestructureData_exe, ShpToMesh_exe, VerticalInterpolate_exe, libTempestRemap
...
JLLWrappers.@declare_executable_product(ConvertExodusToSCRIP_exe)
JLLWrappers.@declare_executable_product(ConvertSCRIPToExodus_exe)
...
function __init__()
    JLLWrappers.@generate_init_header(libblastrampoline_jll, NetCDF_jll, HDF5_jll, LibCURL_jll, LibSSH2_jll, MbedTLS_jll, nghttp2_jll)
    ...
    JLLWrappers.@init_executable_product(
        ConvertExodusToSCRIP_exe,
        "bin/ConvertExodusToSCRIP",
    )

    JLLWrappers.@init_executable_product(
        ConvertSCRIPToExodus_exe,
        "bin/ConvertSCRIPToExodus",
    )
